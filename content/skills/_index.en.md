  ...
  - name: "Monitoring & Observability"
    skills:
      ...
      - name: "InfluxDB & Telegraf"
        level: 80
        years: "6+"
        description: "Time-series database, Metrics collection, Data retention, Flux queries"
      - name: "ELK Stack"
        level: 70
        years: "4+"
  ...
  - name: "IT Security & Identity Management"
    skills:
      ...
      - name: "HashiCorp Vault"
        level: 75
        years: "3+"
        description: "Secrets management, Dynamic secrets, PKI"
  ...
  - name: "Cloud & Virtualization"
    skills:
      ...
      - name: "Amazon Web Services (AWS EC2)"
        level: 70
        years: "3+"
        description: "Virtual machines, Load balancing, Auto-scaling, VPC, IAM, CloudWatch"
      - name: "Citrix XenServer"
        level: 70
        years: "6+"
        description: "VM management, Storage repositories, High availability, Live migration"
  ...
  - name: "Network Services"
    skills:
      - name: "BIND9 DNS"
        level: 85
        years: "10+"
        description: "Zone management, DNSSEC, Split-DNS, Record types, Troubleshooting"
      - name: "ISC DHCP"
        level: 80
        years: "7+"
        description: "IP address management, Failover, PXE boot, Reservations, Scopes"
      - name: "pfSense"
        level: 75
        years: "5+"
...
As an IT Consultant and System Administrator with over 12 years of experience, I have developed comprehensive expertise in Linux system administration, Atlassian tools, monitoring solutions, and IT automation. My technical skills are based on solid practical experience from numerous projects in mid-sized and enterprise environments.
